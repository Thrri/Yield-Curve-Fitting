...
## This file is aimed at fitting the Icelandic spot rate curve to various models. 
...
$$
Z^{\text{Vasicek}}(t, r_0, T) = e^{\left(\frac{1}{\gamma^*} \left(1 - e^{-\gamma^*(T-t)} \right)-(T-t)\right) \left(\bar{r}^* - \frac{\sigma^2}{2(\gamma^*)^2}\right)-\frac{\sigma^2 \left(\frac{1}{\gamma^*} \left(1 - e^{-\gamma^*(T-t)} \right)\right)^2}{4\gamma^*} - \frac{1}{\gamma^*} \left(1 - e^{-\gamma^*(T-t)} \right)\times r_0} 
$$
